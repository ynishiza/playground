...
newtype GGraph a = GGraph [Edge (GGraph a)] 
...
deriving instance Eq a => Eq (Edge (GGraph a))
deriving instance Ord a => Ord (Edge (GGraph a))
deriving instance Show a => Show (Edge (GGraph a))
deriving instance Eq a => Eq (GGraph a)
deriving instance Show a => Show (GGraph a)
